...
router.post('/', validation(createWorkspaceSchema), workspaceController.createWorkspace);

router.get('/', workspaceController.getAllWorkspaces);

router.get('/:workspaceId', authorizeWorkspaceRole('OWNER', 'ADMIN', 'MEMBER'), workspaceController.getWorkspaceById);

router.patch('/:workspaceId', authorizeWorkspaceRole('OWNER', 'ADMIN'), validation(updateWorkspaceSchema), workspaceController.updateWorkspace);
